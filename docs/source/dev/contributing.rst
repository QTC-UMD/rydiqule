...
The (code) reviewer needs to understand what you have done any why,
and ultimately you need to *persuade* them to accept.
...
- Commits are most like paragraphs in a paper.
  You should also tend to use many small commits within a PR,
